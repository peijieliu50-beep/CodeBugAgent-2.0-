...
class ReActResult:
    ...
    messages: List[Dict[str, Any]] = field(default_factory=list)  # 完整对话消息（含系统/工具），供多轮接续
    ...
    def run(
        ...
        for i in range(1, self.max_iterations + 1):
            ...
            try:
                ...
                steps.append(step)
                return ReActResult(False, f"调度中断：{e}", steps, i, "error", messages)
            ...
            if not resp.has_tool_calls:
                ...
                return ReActResult(True, final, steps, i, "final_answer", messages)
        ...
        return ReActResult(False, summary, steps, self.max_iterations, "max_iterations", messages)
